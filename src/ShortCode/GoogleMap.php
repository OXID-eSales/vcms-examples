...
class GoogleMap extends BaseShortCode
{
    ...
    public function getOptions(): OptionList
    {
        ...
        return new OptionList([
            'link' => new TextOption(
                label: $this->translate('SHOP_MODULE_oevcmsexamples_GoogleMap_link'),
                value: $link
            ),
            'height' => new TextOption(
                label: $this->translate('SHOP_MODULE_oevcmsexamples_GoogleMap_width'),
                value: '450'
            ),
            'width' => new TextOption(
                label: $this->translate('SHOP_MODULE_oevcmsexamples_GoogleMap_height'),
                value: '600'
            )
        ]);
    }
